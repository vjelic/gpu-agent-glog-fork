...
class full_formatter SPDLOG_FINAL:public flag_formatter
{
    void format(details::log_msg& msg, const std::tm& tm_time) override
    {
        ...
        auto duration = msg.time.time_since_epoch();
        auto millis = std::chrono::duration_cast<std::chrono::milliseconds>(duration).count() % 1000000;
        ...
        msg.formatted << '[' << static_cast<unsigned int>(msg.boot_number) << ' '
                      ...
                      << fmt::pad(static_cast<unsigned int>(millis), 6, '0') << "] ";
...
inline void spdlog::pattern_formatter::handle_flag(char flag)
{
    ...
    case ('Q'):
        _formatters.push_back(std::unique_ptr<details::flag_formatter>(new details::q_formatter()));
        break;
