...
///
/// \file
/// gpu watch object CRUD API handlers
///
//----------------------------------------------------------------------------
...
sdk_ret_t
aga_gpu_watch_create_cb (api_base *api_obj, api_params_base *api_params)
{
    return api_obj->create_handler(api_params);
}

sdk_ret_t
aga_gpu_watch_delete_cb (api_base *api_obj, api_params_base *api_params)
{
    return api_obj->delete_handler(api_params);
}

sdk_ret_t
aga_gpu_watch_update_cb (api_base *api_obj, api_params_base *api_params)
{
